...
class TypeIIMessage extends McduMessage {
   ...
   */
  getModifiedMessage(t: string, isResolved?: () => boolean, onClear?: () => void) {
...
export const NXTestMessages = {
  type1: new TypeIMessage('TYPE 1 MSG'),
  type1Amber: new TypeIMessage('TYPE 1 MSG AMBER', true),
  type1ReplaceXXXX: new TypeIMessage('TYPE 1 REPLACE XXXX', false, 'XXXX'),
